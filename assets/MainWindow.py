...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.reflection_label, 1, 0, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.wavelength_label.setText(_translate("MainWindow", "Длина волны"))
        self.reflection_label.setText(_translate("MainWindow", "Коэффициент отражения зеркал"))
